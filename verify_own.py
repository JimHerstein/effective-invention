...
polygon1 = Polygon([[150, 350], [400, 350], [400, 200], [150, 200]])
...
out1 = cv2.VideoWriter(r'D:\projects\safe\video\speed.avi', fourc, 30.0, (640, 480))
out2 = cv2.VideoWriter(r'D:\projects\safe\video\shadow.avi', fourc, 30.0, (640, 480))
out3 = cv2.VideoWriter(r'D:\projects\safe\video\wshadow.avi', fourc, 30.0, (640, 480))


def shadow(frame):
    gimg = cv2.cvtColor(frame, cv2.COLOR_BGR2GRAY)
    _, th = cv2.threshold(gimg, 200, 255, cv2.THRESH_BINARY)
...
while ret:
    ...
    frame = frame[:, 200:]
    img = frame.copy()
    pts1 = np.array([[150, 350], [400, 350], [400, 200], [150, 200]], np.int32)
